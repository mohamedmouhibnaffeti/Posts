                ...
                posts.map((post, index)=>(
                    <div className="innerPostsSection">
                        <div className="UserHeader">
                            ...
                            <div onClick={()=>deletePost(post._id)} style={{backgroundColor: "red", borderRadius: "10px", outline: "none", color: "white", paddingTop: "2px", paddingBottom: "4px", paddingLeft: "12px", paddingRight: "12px", cursor: "pointer"}}>
                                Delete
                            </div>
                        </div>
                        <div className="Title">
